...
<template>
    <div ref="containerRef" class="header-calendar" >
        <TextButton class="header-calendarBtn" @click="handleToggle">
            ...
            <DatePicker v-if="dateDropdownOpen" :value="value" class="header-calendar-picker" :bordered="false" picker="date" :open="dateDropdownOpen" :getPopupContainer="getPopupContainer" @change="handleChange"  />
        </TextButton>
    </div>
</template>
